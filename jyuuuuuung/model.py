...
train_x, test_x, train_y, test_y = train_test_split(
    input_array, output_array, test_size=0.1, shuffle=False)
train_x, val_x, train_y, val_y = train_test_split(
    train_x, train_y, test_size=0.1, shuffle=False)
...
for i, q in enumerate(np.arange(0.1, 1, 0.1)):
    ...
    #   model.reset_states()
    model.fit(train_x, train_y, epochs=500, batch_size=1, shuffle=False,
